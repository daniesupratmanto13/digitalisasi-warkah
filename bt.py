...
bt = "BT_160106071"
sumber = glob.glob((r"/home/danie/Desktop/wsb/sumber/BT.pdf"))
temp = (r"/home/danie/Desktop/wsb/temp")
target = (r"/home/danie/Desktop/wsb/target")
...
fo = open((r'/home/danie/Desktop/wsb/name.txt'), 'r')
...
for p in pages:
    ...
    outputStream = open((r"/home/danie/Desktop/wsb/temp/")+newName, "wb")
